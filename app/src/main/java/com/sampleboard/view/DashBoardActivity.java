...
public class DashBoardActivity extends MainActivity {
    ...
    private static DigitalSignatureFragment initializeDigitalSignatureFragment() {
        if (digitalSignatureFragment == null)
            digitalSignatureFragment = new DigitalSignatureFragment();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        changeScreen(R.id.dashboard_container, CurrentScreen.ITEM_LIST_SCREEN, true, false, null);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.action_search:
                        ...
                        changeScreen(R.id.dashboard_container, CurrentScreen.SEARCH_SCREEN, true, false, null);
                        break;
